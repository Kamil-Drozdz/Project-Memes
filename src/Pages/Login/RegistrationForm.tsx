...
const RegistrationForm: React.FC<RegistrationFormProps> = ({ texts, handleSubmit, error, isLoading, setShowRegistration, email, setEmail, password, setPassword, confirmPassword, setConfirmPassword }) => {
  return (
