      ...
      <div className="w-full h-full">
        ...
        <form onSubmit={handleSubmit} className="flex justify-start w-full flex-col space-y-4">
          <div className="flex w-full  flex-col items-start ">
            <label htmlFor=" userNick" className="text-lg font-semibold">
              Nickname :
            </label>
            <input id=" userNick" name="userNick" value={userData.userNick || ''} onChange={handleUserDataChange} className="border-[1px] border-gray-900 p-2 rounded-md" type="text" placeholder="Twój nick" />
          </div>
